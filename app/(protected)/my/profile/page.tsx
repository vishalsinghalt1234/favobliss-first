...
import ClientEditSection from "@/components/store/ClientEditSection";
  ...
  return (
    <div className="w-full p-4 md:py-8 rounded-md border border-zinc-300 flex justify-center">
      <div className="max-w-md w-full space-y-5">
        <h2 className="text-zinc-700 font-bold text-lg">Profile Details</h2>
        <div className="flex flex-col gap-y-2">
          ...
          <div className="grid grid-cols-2 items-start">
            <h5 className="text-zinc-600 font-medium">Date of Birth</h5>{" "}
            {/* Fixed typo from "Gender" */}
            <span className="text-zinc-600 font-medium">
              {user.dob !== null
                ? format(user.dob, "dd MMMM yyyy")
                : "Not available"}
            </span>
          </div>
            <ClientEditSection
          ...
          currentDob={user.dob ? format(user.dob, "yyyy-MM-dd") : ""}
        />
        </div>
